...
new_crime_df = crime_df_filtered.join(minimum_distances_df.hint("shuffle_replicate_nl"), "DR_NO")
...
query_4a_2 = df_average_distances.join(df_num_crimes.hint("merge"),'YEAR') \
                                 .orderBy(asc('YEAR'))
...
new_crime_df_2 = distances_df_2.join(minimum_distances_df_2.hint("broadcast"), ['DR_NO','DISTANCE'], how = "right")
...
#join the 2 previous dataframes                            
query_4b_2 = df_average_distances_2.join(df_num_crimes_2.hint("shuffle_hash"),'DIVISION') \
